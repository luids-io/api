...
import (
	...
	"github.com/luids-io/api/regexscan"
	"github.com/luids-io/api/regexscan/grpc/pb"
)

// Service provides a wrapper for the interface regexscan.BlockScanner that handles
// grpc requests.
type Service struct {
	opts    serviceOpts
	scanner regexscan.StreamScanner
}
...
func NewService(s regexscan.StreamScanner, opt ...ServiceOption) *Service {
